    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> কুড়িল-খিলখেত, ঢাকা </p>
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <a class="footer-link" target="_blank" href="{{url('/Term')}}">শর্ত সমূহ </a><br>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব পারভেজ দ্বারা সংরক্ষিত; ২০২০-২০২১ </p>
</div>
